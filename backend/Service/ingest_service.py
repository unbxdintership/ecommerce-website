...
class IngestService:
    ...
    #     product_availability = product_info['product_availability']
    #     product_name = product_info['product_name']
    #     product_catlevel1 = product_info['product_catlevel1']
    #     product_catlevel2 = product_info['product_catlevel2']
    ...
    def verify_product(self, product_ID):
        result = self.dboperator.operation(get_all_prdinfo, (product_ID.strip(),), res=1)
        # result = response[0]
        if result:
            return 1
        return 0
    ...
    def update_title(self, product_ID, product_title):
        self.dboperator.operation(update_ptitle_prdinfo, (product_title.strip(), product_ID.strip(),))
        return 1

    def update_price(self, product_ID, product_price):
        self.dboperator.operation(update_pprice_prdinfo, ((str(product_price)).strip(), product_ID.strip(),))
        return 1

    def update_description(self, product_ID, product_description):

        self.dboperator.operation(update_pdescription_prdinfo, (product_description.strip(), product_ID.strip(),))
        return 1

    def update_image(self, product_ID, product_image):
        self.dboperator.operation(update_pimage_prdinfo, (product_image.strip(), product_ID.strip(),))
        return 1

    def update_availability(self, product_ID, product_availability):
        self.dboperator.operation(update_pavailability_prdinfo, (product_availability.strip(), product_ID.strip(),))
        return 1

    def update_name(self, product_ID, product_name):

        self.dboperator.operation(update_pname_prdinfo, (product_name.strip(), product_ID.strip(),))
        return 1