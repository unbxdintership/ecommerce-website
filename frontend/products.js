    ...
    if (keys.includes("products")) {
        ...
        if (products.length != 0) {
            ...
            if (page != 1) {
                ...
                previous_button.href = `./products.html?&page=${page - 1}`;
            ...
            if (page - 1 != 0) {
                ...
                previous_button_number.href = `./products.html?&page=${page - 1}`;
            ...
            current_button.href = `./products.html?&page=${page}`;
            ...
            if (page + 1 <= pages) {
                ...
                next_button_number.href = `./products.html?&page=${page + 1}`;
            ...
            if (page != pages) {
                ...
                next_button.href = `./products.html?&page=${page + 1}`;
