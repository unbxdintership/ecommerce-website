...
async function render_products() {
    ...
    var catlvl1 = urlParams.get('catlvl1');
    var catlvl2 = urlParams.get('catlvl2');
    ...
    if (keys.includes("products")) {
        ...
        if (page != 1) {
            ...
            previous_button.href = `./category.html?catlvl1=${catlvl1}&catlvl2=${catlvl2}&page=${page - 1}`;  // to be changed
        ...
        if (page - 1 != 0) {
            ...
            previous_button_number.href = `./category.html?catlvl1=${catlvl1}&catlvl2=${catlvl2}&page=${page - 1}`; // to be changed
        ...
        current_button.href = `./category.html?catlvl1=${catlvl1}&catlvl2=${catlvl2}&page=${page}`; // to be changed
        ...
        if (page + 1 <= pages) {
            ...
            next_button_number.href = `./category.html?catlvl1=${catlvl1}&catlvl2=${catlvl2}&page=${page + 1}`; // to be changed
        ...
        if (page != pages) {
            ...
            next_button.href = `./category.html?catlvl1=${catlvl1}&catlvl2=${catlvl2}&page=${page + 1}`; // to be changed
